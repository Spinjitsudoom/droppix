...
struct ClientSettings { int width = 0, height = 0; int fps = 60; bool audio = false; int rotation = 0; int bitrate_kbps = 8000; bool flip_horizontal = false; int brightness = 0; int contrast = 100; int wall_col = 0, wall_row = 0; };
